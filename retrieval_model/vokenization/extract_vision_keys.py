...
def get_img_path(img_set, img_id):
    ...
    elif 'open_images' in img_set:   # open images
        return "%s/images/%s.jpg" % (common.OI_ROOT, img_id)
    else:   # VG images or Open Images images
...
if __name__ == "__main__":
    ...
    if args.torchvision_model is not None:
        ...
        if os.path.exists(args.load_dir + '/BEST.pth.model'):
            print('Here is loading the trained visn model part-----')
