...
for img_set in img_sets:
    ...
    for start_id in tqdm.tqdm(range(0, len(sentXimgname), batch_size)):
        ...
        print(sents, gt_img_names)

        scores, ids, tokens, paths_list = vokenizer.vokenize_sents(sents, topk=arg_topk)

        # print(scores, ids, tokens)
        # print(len(scores[0]), len(ids[0]), len(tokens[0]), len(paths_list[0]))
        # print('.......................')
        # print(scores)
        # print('before path:',paths_list)
        if sent_level:
