...
COCO_ROOT = '/data/t-zujieliang/data_for_vokenization/mscoco'
VG_ROOT = '/data/t-zujieliang/data_for_vokenization/vg'
LXRT_ROOT = '/data/t-zujieliang/data_for_vokenization/lxmert'



OI_ROOT = '/data/t-zujieliang/data_for_vokenization/open_images'
