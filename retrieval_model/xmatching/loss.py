...
def sent_paired_hinge_rank_loss(
    ...
    :param sent_output: [batch_size, hid_dim] : first token output of the lang_output
    ...
    # sent_output: [batch_size, hid_dim] : first [CLS] token output of the lang_output
    # sent_output = lang_output[:,0,:] # [b, hid_dim]
    sent_output = lang_output # [b, hid_dim]
    

    # Split to positive and negative sets.
    half_batch_size = batch_size // 2
    pos_lang, neg_lang = torch.split(sent_output, half_batch_size, dim=0)
